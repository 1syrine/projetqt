    ...
    if (isValid) {
        ...
        if (test) {
            ...
            QMessageBox::information(nullptr, QObject::tr("ok"),
                                     QObject::tr("Ajout effectué.\n"
                                                 "Click Cancel to exit."), QMessageBox::Cancel);
            QFile file("C:/Users/21655/Downloads/projetqt-master/projetqt-master/historique.txt");
...
{
    QFile file("C:/Users/21655/Downloads/projetqt-master/projetqt-master/historique.txt"); // Remplacez "chemin/vers/votre/fichier.txt" par le chemin de votre fichier texte
